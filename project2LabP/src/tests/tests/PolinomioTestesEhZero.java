...
public class PolinomioTestesEhZero {
    ...
    public void grau0NaoEhZero () {
        ...
        assertFalse(p.ehZero());
    }
    
    @Test(timeout = 1000)
    public void grau0NaoEhZeroCoefPequenoErroDefault () {
        Complexo[] coefs= new ComplexoConcreto[1];
        coefs[0] = new ComplexoConcreto(Complexo.getErro() + Complexo.getErro() / 10,
    ...
    @Test(timeout = 1000)
    public void grau0NaoEhZeroCoefPequenoErroParametro () {
        Complexo[] coefs= new ComplexoConcreto[1];
        coefs[0] = new ComplexoConcreto(Complexo.getErro() + Complexo.getErro() / 10,
                                        Complexo.getErro() + Complexo.getErro() / 10);
        p = new PolinomioVetor (coefs);
        assertFalse(p.ehZero(Complexo.getErro()));
    }
    ...
    @Test(timeout = 1000)
    public void grau0EhZeroCoefPequenoErroDefault () {
        Complexo[] coefs= new ComplexoConcreto[1];
        coefs[0] = new ComplexoConcreto(Complexo.getErro() - Complexo.getErro() / 10,
        		                        Complexo.getErro() - Complexo.getErro() / 10);
        p = new PolinomioVetor (coefs);
    ...
    @Test(timeout = 1000)
    public void grau0EhZeroCoefPequenoErroParametro () {
        Complexo[] coefs= new ComplexoConcreto[1];
        coefs[0] = new ComplexoConcreto(Complexo.getErro() - Complexo.getErro() / 10,
        		                        Complexo.getErro() - Complexo.getErro() / 10);
        p = new PolinomioVetor (coefs);
        assertTrue(p.ehZero(Complexo.getErro()));
    }
